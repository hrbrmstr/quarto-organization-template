...
title-slide-attributes: # this is if you want a background image on the title screen. Use the right path to the image you want
  data-background-image: "_extensions/organization/space.jpg"
...
format:
  organization-revealjs:
    ...
    width: 1600
    height: 900
    logo: "_extensions/organization/logo.png"
...
## { background-image="_extensions/organization/space.jpg" background-opacity="0.5" } 
